...
const scoreRedText = document.querySelector(".score__text-red");
const scoreGreenText = document.querySelector(".score__text-green");
while (arr.length !== 10) {
...
for (let i = 0; i < allItems.length; i++) {
  allItems[i].addEventListener("click", function () {
    ...
    if (greenCount === 10) {
      endModal.querySelector(".modal__title").textContent = "You win";
